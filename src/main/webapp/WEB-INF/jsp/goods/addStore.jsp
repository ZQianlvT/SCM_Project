...
<body>
	<form style="padding:15px;margin:0px;background:#eee;" id="ff" action="">
		...
		已付：
		<input type="text" id="boPaid" name="boPaid" /><br>
		欠款：
		<input type="text" id="boArrears" name="boArrears" /><br>
		原始单号：
		<input type="text" id="boOriginal" name="boOriginal" /><br>
		经手人：
		<input type="text" id="boAttn" name="boAttn" /><br>
		操作员：
		<input type="text" id="boOperator" name="boOperator" /><br>
		备注：
		<input type="text" id="boRemark" name="boRemark" /><br>
	</form>
	<table id="dg"></table>
</body>
</html>